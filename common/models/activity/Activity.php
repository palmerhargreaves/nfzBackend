...
class Activity extends CustomRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['finished', 'importance', 'sort', 'has_concept', 'many_concepts', 'is_concept_complete', 'hide', 'select_activity', 'is_limit_run', 'allow_to_all_dealers', 'stat_year', 'position', 'is_own', 'allow_extended_statistic', 'allow_certificate', 'allow_share_name', 'own_activity', 'required_activity', 'mandatory_activity', 'allow_special_agreement'], 'integer'],
