...
?>
<h4 class="header">Параметры спец. согласования</h4>

<div class="card-panel" style="padding-top: 3px;">
    <div class="row">
        <ul id="task-card" class="collection with-header">
            <li class="collection-header blue-grey">
                <h6 class="task-card-title">Управление параметрами спец. согласования</h6>
            </li>

            <li class="collection-item dismissable">
                <div class="row" style="margin-top: 20px;">
                    <div class="col s10 m10 l10">
                        <p>Пользователи (импортеры) проверяющие концепции</p>
